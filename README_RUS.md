...
Резюме:
В этом проекте ты узнаешь, как выявлять требования и какие из них предпочтительней применять в каких случаях. Применив несколько способов определения требований, ты выявишь бизнес-требования и построишь функционально-ролевую модель, а также научишься документировать требования.
...
6. Границы системы. Очертить границы по бизнес-требованиям обычно очень сложно. Часто границы системы очерчивают по одному из перечисленному в п.5;
...
1. Определи цель игры как погружение в задачу.
2. После распределения ролей каждому участнику:
   1. Погрузись в роль;
   2. Изучи потребности и возможности роли.
3. Придумай легенду, подготовь краткий рассказ о своей роли.
4. Будь готов отвечать на вопросы других членов команды.
...
1. Прочитай или посмотри материалы: условия задачи, отчеты по интервью, результаты ex00 и ex02 в BSA 02, важные документы или интернет-ресурсы, относящиеся к задаче;
2. Восстанови в памяти свои разработки по задаче;
3. Размести материалы задачи в непосредственной близости к месту мозгового штурма, чтобы поднять их при необходимости.
...
1. Создай документ «Видение», укажи название системы.
2. Создай Введение, отрази:
   1. Для кого предназначен документ;
   2. Цель и область применения;
   3. Исполнителя.
3. Опиши исходную информацию:
...
4. Опиши бизнес-требования (см. раздел 3. «Как описать бизнес-требования»):
...
5. Опиши границы проекта:
   1. Основные роли системы и их функции в системе.
6. Размести документ в turn-in файле ex03\_<префикс продукта>\_vision.docx.

💡 [Нажми сюда](https://forms.yandex.ru/cloud/65b908f6068ff008a5c88675/), **чтобы поделиться с нами обратной связью на этот проект**. Это анонимно и поможет команде Продукта сделать твоё обучение лучше.